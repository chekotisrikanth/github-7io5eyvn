...
SELECT 
  ...
  END,
  CASE p.email
    WHEN 'designer1@example.com' THEN '{"fullRoomDesign": true, "consultation": true, "eDesign": true}'
    WHEN 'designer2@example.com' THEN '{"fullRoomDesign": true, "consultation": true, "eDesign": false}'
    WHEN 'designer3@example.com' THEN '{"fullRoomDesign": true, "consultation": true, "eDesign": true}'
    WHEN 'designer4@example.com' THEN '{"fullRoomDesign": true, "consultation": false, "eDesign": true}'
    WHEN 'designer5@example.com' THEN '{"fullRoomDesign": true, "consultation": true, "eDesign": true}'
  END,
  CASE p.email
    WHEN 'designer1@example.com' THEN '{"type": "fixed", "rate": 150}'
    WHEN 'designer2@example.com' THEN '{"type": "hourly", "rate": 200}'
    WHEN 'designer3@example.com' THEN '{"type": "fixed", "rate": 125}'
    WHEN 'designer4@example.com' THEN '{"type": "hourly", "rate": 175}'
    WHEN 'designer5@example.com' THEN '{"type": "fixed", "rate": 160}'
  END,
  CASE p.email
